...
I'm stepping down as maintainer of the AHLCG plugin, as I've got my own project to focus on.
If you want to take over the duties, simply fork the project, and let your community and other AH communities know where to find your version, and tell us why your version is better!

This also means, that outside of a last few updates that I've promised the community (High resolution templates), and the occasional PR merge, I won't be updating this repo going forward.
