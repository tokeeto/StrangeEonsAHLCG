...
function onRead(diy, oos) {
	...
	if ( diy.version < 17 ) {
		scaleTextFieldSizes( diy, [ 'AgendaStory', 'Rules', 'HeaderABack', 'AccentedStoryABack', 'RulesABack', 'HeaderBBack', 'AccentedStoryBBack', 'RulesBBack', 'HeaderCBack', 'AccentedStoryCBack', 'RulesCBack' ], 4 );
	}
	diy.version = 17;
}
