...
//	var StatsPanel = layoutKeyStats( bindings, FACE_FRONT );
...
//	var BackStatsPanel = layoutKeyStats( bindings, FACE_BACK );
...
function createBackPainter( diy, sheet ) {
	...
	setTextShape( BackBody_box, diy.settings.getRegion( getExpandedKey( FACE_FRONT, 'Body-region') ) );
...
function paintBack( g, diy, sheet ) {
	...
	drawCollectorInfo( g, diy, sheet, BackCollection_box, false, true, BackEncounter_box, true, BackCopyright_box, BackArtist_box );
}

function setTextShape( box, region ) {
	var AHLCGObject = Eons.namedObjects.AHLCGObject;

	box.pageShape = AHLCGObject.getKeyTextShape( region );
}
