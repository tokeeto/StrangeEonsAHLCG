...
function paintBack( g, diy, sheet ) {
	...
	if ( $SubtitleBack.length > 0 ) drawSubtitle( g, diy, sheet, BackSubtitle_box, '' );
...
//	drawCollectorInfo( g, diy, sheet, true, false, true, true, true );
	drawCollectorInfo( g, diy, sheet, collectionBox, collectionSuffix, true, encounterBox, encounterIcon, copyrightBox, BackArtist_box );
...
function onRead(diy, oos) {
	...
	if ( diy.version < 20 ) {
		scaleTextFieldSizes( diy, [ 'TraitsA', 'HeaderA', 'AccentedStoryA', 'RulesA', 'HeaderB', 'AccentedStoryB', 'RulesB', 'HeaderC', 'AccentedStoryC', 'RulesC', 'TraitsBack', 'KeywordsBack', 'RulesBack', 'FlavorBack', 'VictoryBack' ], 4 );
	}
	diy.version = 20;
}
